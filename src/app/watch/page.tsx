...
function WatchPageContent({}: WatchPageContentProps) {
  ...
  console.log(`[WatchPageContent] Initializing. episodeIdFromQuery: ${episodeIdFromQuery}, animeId: ${animeId}`);
  ...
  useEffect(() => {
    async function fetchData() {
      console.log(`[WatchPageContent] fetchData triggered. episodeIdFromQuery: ${episodeIdFromQuery}, selectedServer: ${selectedServer}`);
      if (!episodeIdFromQuery) {
